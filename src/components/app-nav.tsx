...
const NAV: NavItem[] = [
  ...
  { to: "/offers", label: "offers", icon: Briefcase, roles: ["admin", "hr", "manager"] },
  { to: "/candidates", label: "candidates", icon: UserSearch, roles: ["admin", "hr", "manager"] },
  { to: "/interviews", label: "interviews", icon: ClipboardCheck, roles: ["admin", "hr", "manager"] },
  { to: "/employees", label: "employees", icon: Users, roles: ["admin", "hr", "manager"] },
  { to: "/org", label: "org", icon: Network, roles: ["admin", "hr", "manager", "employee"] },
  ...
  { to: "/performance", label: "performance", icon: Target, roles: ["admin", "hr", "manager", "employee"] },
  { to: "/trainings", label: "trainings", icon: GraduationCap, roles: ["admin", "hr", "manager", "employee"] },
  ...
  { to: "/profile", label: "profile", icon: UserCircle2, roles: ["admin", "hr", "manager", "employee", "candidate"] },
