...
export function seedIfEmpty() {
  ...
  const candidates: Candidate[] = [
    ...
    { id: "cand5", companyId: cid, firstName: "Sarah", lastName: "Cohen", email: "sarah.c@example.com", phone: "+33 6 55 66 77 88", skills: ["UI", "UX"], experiences: "4 ans designer", education: "Master Design", jobOfferId: "off2", stage: "technical_test", rating: 4, tags: [], favorite: false, notes: [], history: [], createdAt: new Date().toISOString() },
    { id: "cand6", companyId: cid, firstName: "Antoine", lastName: "Mercier", email: "antoine.m@example.com", phone: "+33 6 66 77 88 99", skills: ["SEO", "Marketing"], experiences: "1 an stage", education: "Master Marketing", jobOfferId: "off3", stage: "manager_interview", rating: 4, tags: [], favorite: false, notes: [], history: [], createdAt: new Date().toISOString() },
  ];
  ...
  const interviews: Interview[] = [
    ...
    { id: "iv3", companyId: cid, candidateId: "cand6", jobOfferId: "off3", type: "manager", date: inDays(-3), interviewers: ["emp5"], location: "Sur site", score: 16, status: "done", decision: "pass", notes: "Bon profil junior." },
  ];
  ...
  const leaves: LeaveRequest[] = [
    ...
    { id: "lv3", companyId: cid, employeeId: "emp8", type: "sick", startDate: inDays(-2), endDate: inDays(-1), status: "approved", createdAt: new Date().toISOString() },
  ];
  ...
  const attendance: Attendance[] = employees.flatMap((e) =>
    Array.from({ length: 5 }).map((_, i) => {
      ...
      return {
        id: uid(), companyId: cid, employeeId: e.id, date: d.toISOString().slice(0, 10),
  ...
  const objectives: Objective[] = [
    ...
    { id: "ob3", companyId: cid, employeeId: "emp6", title: "+20% nouveaux clients", description: "", dueDate: inDays(90), progress: 40, status: "in_progress" },
  ];
  ...
  const evaluations: Evaluation[] = [
    ...
    { id: "ev2", companyId: cid, employeeId: "emp3", period: "2025-S1", selfScore: 4, managerScore: 4.2, hrScore: 4.1, date: "2025-07-01" },
  ];
