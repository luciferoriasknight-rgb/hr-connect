...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "OLA Victoria Dicone — Développeur Fullstack" },
      { name: "description", content: "Portfolio d'OLA Victoria Dicone (Lord-Coding), développeur fullstack web & mobile basé à Pointe-Noire, Congo." },
